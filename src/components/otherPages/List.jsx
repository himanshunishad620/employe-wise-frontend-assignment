...
const List = () => {
  ...
  return (
    <div className="p-0 lg:p-5 w-full lg:w-3/5 m-auto  ">
      <div className="px-5 w-full h-13 flex gap-3 justify-between items-center bg-[#7900BA]">
        ...
        <button
          ...
          className="h-8 w-10 flex justify-center items-center rounded text-white text-2xl  cursor-pointer"
        >
          <FiLogOut />
        </button>
      </div>
